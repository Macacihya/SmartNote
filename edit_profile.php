...
// Ambil data user saat ini dari session untuk ditampilkan di form
...
<div class="table-wrapper-card">
    ...
    <form method="post" action="backend/auth/save_profile.php" enctype="multipart/form-data">
        ...
        <div class="mb-4 text-center">
            ...
            <img src="<?= isset($currentUser['profile_picture_path']) && file_exists($currentUser['profile_picture_path']) ? htmlspecialchars($currentUser['profile_picture_path']) : 'https://i.pravatar.cc/150' ?>" 
                 alt="Foto Profil" 
                 class="rounded-circle mb-2" 
                 style="width: 120px; height: 120px; object-fit: cover; border: 3px solid #eee;">
            <input type="file" name="profile_picture" id="profile_picture" class="form-control form-control-sm" style="max-width: 300px; margin: auto;">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-9">
                <input type="text" name="name" id="name" class="form-control" value="<?= htmlspecialchars($currentUser['name']) ?>" required>
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-9">
                <input type="email" id="email" class="form-control" value="<?= htmlspecialchars($currentUser['email']) ?>" disabled readonly>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-9">
                <input type="password" name="current_password" id="current_password" class="form-control" placeholder="Masukkan password saat ini jika ingin ganti">
            </div>
        </div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-9">
                <input type="password" name="new_password" id="new_password" class="form-control" placeholder="Kosongkan jika tidak ganti password">
            </div>
        </div>
        ...
        <div class="mt-4 d-flex gap-2 justify-content-end">
            ...
            <button type="submit" class="btn btn-sm btn-green"><i class="bi bi-save me-1"></i> Simpan Perubahan Profil</button>
        </div>
