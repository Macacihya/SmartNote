            ...
            <div class="row text-center g-4 justify-content-center">
                ...
                <div class="col-md-3 col-6">
                    <div class="card p-3 shadow-sm h-100 border-0 team-card">
                        <img src="Rian.jpg" alt="Foto Rian - Ketua Proyek"
                            class="team-img">
                ...
                <div class="col-md-3 col-6">
                    <div class="card p-3 shadow-sm h-100 border-0 team-card">
                        <img src="yohana.png" alt="Foto Yohana - Spesialis UI/UX"
                            class="team-img">
                ...
                <div class="col-md-3 col-6">
                    <div class="card p-3 shadow-sm h-100 border-0 team-card">
                        <img src="della.png" alt="Foto Della - Frontend Developer"
                        class="team-img">
                ...
                <div class="col-md-3 col-6">
                    <div class="card p-3 shadow-sm h-100 border-0 team-card">
                        <img src="didit.jpg" alt="Foto Didit - Backend Developer"
                            class="team-img">
